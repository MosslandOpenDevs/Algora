 ...
 *
 * Mounted on the Algora root layout so every page surfaces a small
 * "before you leave" hook into the NPC city. Server-rendered with a
 * 10-min revalidate so it doesn't hammer the npc backend on every
 * pageview, and a 4 s timeout fallback to nothing — a sister-service
 * hiccup never breaks Algora's rendering.
 *
 * Stylistically neutral: subtle translucent surface + inline-styled
 * NPC accent colors. Works on both dark and light parent themes.
 */
