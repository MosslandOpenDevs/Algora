  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="flex items-center gap-2 rounded-md px-3 py-1.5 text-sm text-agora-muted transition-colors hover:bg-agora-card hover:text-agora-text"
        aria-label="Help"
      >
        ...
        <div className="absolute right-0 top-full z-50 mt-2 w-56 overflow-hidden rounded-lg border border-agora-border bg-agora-dark shadow-lg">
          <div className="p-2">
            <button
              ...
              className="flex w-full items-center gap-3 rounded-md px-3 py-2 text-left text-sm text-agora-muted transition-colors hover:bg-agora-card hover:text-agora-text"
            >
