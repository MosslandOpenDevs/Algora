 ...
 * lists) are enabled, and single newlines become hard breaks
 * (GitHub-comment style) so line-per-item metadata and legacy
 * plain-text descriptions keep their line structure.
 */
